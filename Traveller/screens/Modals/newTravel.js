      ...
      >
        <ScrollView style={{ flex: 1, width: "100%" }}>
          <View style={{ marginLeft: 20, marginRight:20 }}>
            ...
            <Text style={[styles.title, { marginBottom: 30, marginTop: 60 }]}>
            ...
            <TextInput
              ...
              style={globalStyleComponent.input}
              label="Aggiungi amico al viaggio"
            ...
            <View>
              <Text
                style={[styles.cardSubtitle, { color: "black", marginTop: 30 }]}
              >
                Persone aggiunte al viaggio:
              </Text>
              <View>
                <FlatList
                  data={friendsAdded}
                  ...
                  renderItem={({ item }) => (
                    ...
                    >
                      ...
                      <View>
                        <Text style={styles.personTextTitle}>
            ...
            <TouchableOpacity
              style={
                isLoading ? null : [styles.modalButton, { marginBottom: 10 }]
              }
              onPress={async () => {
                ...
                if (image) {
                  ...
                  axios
                    .post(serverLink + "api/travel/uploadImage", {
                      img: image.assets[0].base64,
                      imgName: fileName,
                    })
                    .then(function (response) {
                      axios
                        .post(serverLink + "api/travel/create", {
                          name: name,
