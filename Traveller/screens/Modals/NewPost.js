...
export default function NewPost({ navigation, route }) {
  ...
  async function addImage() {
    ...
    for (let item of images) {
      ...
      await axios
        .post(`${serverLink}api/post/addImage`, {
          img: item.base64,
          name: fileName,
        })
        .then((res) => {
      ...
      <ScrollView style={{ width: "100%", padding: 20 }}>
        {type == "text" && (
          <TextInput
            ...
            onChangeText={(value) => (textParams.content = value)}
          />
        )}
        {type == "payments" && (
          <>
            <View style={{ flexDirection: "row", alignItems: "center" }}>
              <TextInput
                ...
                style={[globalStyleComponent.input, { width: "90%" }]}
                inputMode="numeric"
            ...
            <TextInput
              ...
              style={[globalStyleComponent.input, { height: 150 }]}
              multiline
              label="Note del pagamento"
              onChangeText={(value) => {
            ...
            <Text
              style={[
                styles.subtitle,
                { textAlign: "left", marginTop: 20, marginBottom: 10 },
              ]}
            >
            ...
            <ScrollView horizontal={true} style={{ paddingBottom: 10 }}>
              <SegmentedButtons
                ...
                buttons={[
                  { label: "Tutti", value: "all", checkedColor: color.primary },
                  {
            ...
            {paymentDestinator == "custom" ? (
              <>
                ...
                >
                  Seleziona i partecipanti che riceveranno la richiesta di
                  pagamento
                </Text>
                <FlatList
                  data={checked}
        ...
        {type == "images" && (
          <View>
            ...
            <TextInput
              ...
              style={globalStyleComponent.input}
              label="Descrizone immagini"
              onChangeText={(text) => setImagesDescription(text)}
            />
            <View>
              {images.length > 0 && (
                <Text
                  ...
                  <>
                    {item.uri != undefined && (
                      <Image
                        source={{ uri: item.uri }}
                        style={{
                          width: (item.width / item.height) * 200,
                          height: 200,
                          marginRight: 10,
                        }}
                      />
        ...
        {type == "todo" && (
          <>
            ...
            <Text
              style={[
                styles.subtitle,
                { textAlign: "left", marginBottom: 0, marginTop: 5 },
              ]}
            >
              Campi della lista:
            </Text>
              ...
              <View style={styles.row} key={item.key}>
                <TextInput
                  ...
                  style={[
                    ...
                    item.label == "" && { borderBottomColor: "red" },
                  ]}
            ...
            <TouchableNativeFeedback
              onPress={() => {
                const newItem = {
                  key: toDoParams.items[toDoParams.items.length - 1].key + 1,
                  label: "",
                  checked: false,
                };
                setToDoParams((prevState) => ({
